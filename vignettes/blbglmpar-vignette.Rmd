---
title: "blbglmpar: Generalized Linear Model with Little Bag of Bootstraps and Parallelization"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{blbglmpar: Generalized Linear Model with Little Bag of Bootstraps and Parallelization}
...
a6 <- c("object or fit", "a blbglm object")
a7 <- c("confidence", "computes confidence interval of estimate if set to TRUE, otherwise ignore")
a8 <- c("level", "level for the confidence interval")
a9 <- c("new_data","dataframe containing variables in formula to be used for prediction")
argframe <- matrix(rbind(a1,a2,a3,a4,a5,a6,a7,a8,a9), nrow = 9, ncol = 2)
argframe %>%
  kable() %>%
